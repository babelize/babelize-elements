      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-6 max-w-sm text-sm leading-relaxed text-white/50">
              Open-source React components for modern localization and internationalization
              management.
            </p>
            <div className="mt-6 flex items-center gap-2">
              <a
                ...
                className="flex size-10 items-center justify-center rounded-xl text-white/40 transition-all hover:bg-white/5 hover:text-white"
              >
                <svg role="img" viewBox="0 0 24 24" className="size-5" fill="currentColor">
              ...
              <a
                href="https://babelize.co"
                target="_blank"
                rel="noopener noreferrer"
                className="flex size-10 items-center justify-center rounded-xl opacity-40 transition-all hover:bg-white/5 hover:opacity-100"
              >
                <Image
                  src="/dark_logo.svg"
                  alt="Babelize"
        ...
        <div className="mt-16 border-t border-white/[0.05] pt-8">
          <p className="text-sm text-white/50">
            © {new Date().getFullYear()} Babelize Elements. Made with{" "}
            <span className="text-red-500">❤️</span> by developers at Babelize, for developers.
          </p>
        </div>
      </div>
    </footer>
