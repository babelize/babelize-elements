...
<PreviewComponents registryName="phone-input">
  <PhoneInputDemo />
</PreviewComponents>
...
<Tabs items={["shadcn", "Elements CLI"]} defaultValue="shadcn" className="bg-transparent border-none">
  <Tab value="shadcn" className="border-none bg-transparent p-0 mt-3">
    <Tabs items={["npx", "pnpm", "yarn", "bun"]} defaultValue="npx" groupId="installation-tabs">
      ...
      <Tab value="pnpm">
        ```bash
        pnpm dlx shadcn@latest add @elements/phone-input
        ```
      </Tab>
      <Tab value="yarn">
        ```bash
        yarn dlx shadcn@latest add @elements/phone-input
        ```
      </Tab>
      <Tab value="bun">
        ```bash
        bunx shadcn@latest add @elements/phone-input
        ```
      </Tab>
    </Tabs>
  </Tab>
  <Tab value="Elements CLI" className="border-none bg-transparent p-0 mt-3">
    <Tabs items={["npx", "pnpm", "yarn", "bun"]} defaultValue="npx" groupId="elements-cli-tabs">
      <Tab value="npx">
        ```bash
        npx @babelize/elements add phone-input
        ```
      </Tab>
      <Tab value="pnpm">
        ```bash
        pnpm dlx @babelize/elements add phone-input
        ```
      </Tab>
      <Tab value="yarn">
        ```bash
        yarn dlx @babelize/elements add phone-input
        ```
      </Tab>
      <Tab value="bun">
        ```bash
        bunx @babelize/elements add phone-input
        ```
      </Tab>
    </Tabs>
  </Tab>
